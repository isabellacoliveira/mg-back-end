...
export class default1671206120572 implements MigrationInterface {
    name = 'default1671206120572'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "produtos" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "descricao" character varying NOT NULL, "preco" numeric(5,2) NOT NULL, "quantidade" integer NOT NULL, "imagem" character varying NOT NULL, "usuario_id" integer, CONSTRAINT "PK_a5d976312809192261ed96174f3" PRIMARY KEY ("id"))`);
