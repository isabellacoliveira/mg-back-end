...
export class ProdutoController {
	async criar(req: Request, res: Response) {
		...
		const { nome, descricao, preco, imagem, usuario, categorias } = req.body
		...
		const novoProduto = produtoRepository.create({ nome, descricao, preco, imagem, usuario, categorias})
	...
	async atualizar(req: Request, res: Response) {
		...
		const { nome, descricao, preco, usuario, imagem, categorias } = req.body;
